...
def calc_metrics(input_data):
    ...
    balanced_accuracy_series = pd.Series(
...
def calc_confusion_matrix(input_data):
    ...
    confusion_matrix_df = pd.DataFrame(confusion_matrix_array, columns=[
                                       'Actual', 'Predicted'], index=['Actual', 'Predicted'])
...
performance_metrics = ['Accuracy', 'Balanced_Accuracy',
                       'Precision', 'Recall', 'MCC', 'F1', 'Cohen_Kappa']
